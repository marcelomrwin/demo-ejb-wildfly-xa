package com.redhat.serviceb.entity;
...
public class Registry {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "SeqGenerator")
    @SequenceGenerator(name = "SeqGenerator", allocationSize = 1)
    private Long id;
